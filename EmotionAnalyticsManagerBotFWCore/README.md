# EmotionAnalyticsManagerBotFWCore
...
## Visual Studio
- Open EmotionAnalyticsManagerBotFWCore.csproj in Visual Studio.
...
- File -> Open bot and open [EmotionAnalyticsManagerBotFWCore.bot](EmotionAnalyticsManagerBotFWCore.bot).
